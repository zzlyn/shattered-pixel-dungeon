...
public class RingOfEnergy extends Ring {
	...
	public static float wandChargeMultiplier( Char target ){
		...
		if (target instanceof Hero && !HeroClass.matches(((Hero) target).heroClass, HeroClass.CLERIC) && ((Hero) target).hasTalent(Talent.LIGHT_READING)){
	...
	public static float artifactChargeMultiplier( Char target ){
		...
		if (target instanceof Hero && !HeroClass.matches(((Hero) target).heroClass, HeroClass.ROGUE) && ((Hero) target).hasTalent(Talent.LIGHT_CLOAK)){
